...
#include <vulkan/vulkan.h>
    ...
    #if VK_EXT_memory_budget && (VK_KHR_get_physical_device_properties2 || 1003000 >= 1001000)
...
// Defined to 1 when VK_KHR_buffer_device_address device extension or equivalent core Vulkan 1.2 feature is defined in its headers.
    ...
    #if VK_KHR_buffer_device_address || 1003000 >= 1002000
...
#endif
#if VMA_KHR_MAINTENANCE4 || 1003000 >= 1003000
...
#endif // #if VMA_DEDICATED_ALLOCATION || 1003000 >= 1001000
    ...
    const void* pNext)
{
    if(pNext != VMA_NULL)
    {
#if 1003000 >= 1001000 || VMA_BIND_MEMORY2
...
#endif // #if 1003000 >= 1001000 || VMA_BIND_MEMORY2
        {
...
#endif // VMA_KHR_MAINTENANCE4 || 1003000 >= 1003000
    {
