...
#define Log(fmt, ...)      logApi->Print(SrcLoc::Here(), LogCategory::Info,  (fmt), ##__VA_ARGS__)
#define LogError(fmt, ...) logApi->Print(SrcLoc::Here(), LogCategory::Error, (fmt), ##__VA_ARGS__)
#define LogErr(err)        logApi->PrintErr(SrcLoc::Here(), err)
