...
struct ErrCode {
	Str const ns;
	Str const code;
                                                                                              [[nodiscard]] Err const * operator()(                                                                                                                        SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0); }
	template <class A1                                                                      > [[nodiscard]] Err const * operator()(Str n1, A1 a1,                                                                                                          SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1); }
	template <class A1, class A2                                                            > [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2,                                                                                           SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2); }
	template <class A1, class A2, class A3                                                  > [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2, Str n3, A3 a3,                                                                            SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2, n3, a3); }
	template <class A1, class A2, class A3, class A4                                        > [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2, Str n3, A3 a3, Str n4, A4 a4,                                                             SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2, n3, a3, n4, a4); }
	template <class A1, class A2, class A3, class A4, class A5                              > [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2, Str n3, A3 a3, Str n4, A4 a4, Str n5, A5 a5,                                              SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2, n3, a3, n4, a4, n5, a5); }
	template <class A1, class A2, class A3, class A4, class A5, class A6                    > [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2, Str n3, A3 a3, Str n4, A4 a4, Str n5, A5 a5, Str n6, A6 a6,                               SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2, n3, a3, n4, a4, n5, a5, n6, a6); }
	template <class A1, class A2, class A3, class A4, class A5, class A6, class A7          > [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2, Str n3, A3 a3, Str n4, A4 a4, Str n5, A5 a5, Str n6, A6 a6, Str n7, A7 a7,                SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2, n3, a3, n4, a4, n5, a5, n6, a6, n7, a7); }
	template <class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8> [[nodiscard]] Err const * operator()(Str n1, A1 a1, Str n2, A2 a2, Str n3, A3 a3, Str n4, A4 a4, Str n5, A5 a5, Str n6, A6 a6, Str n7, A7 a7, Str n8, A8 a8, SrcLoc sl = SrcLoc::Here()) const { return Err::Make(nullptr, sl, ns, code, 0, n1, a1, n2, a2, n3, a3, n4, a4, n5, a5, n6, a6, n7, a7, n8, a8); }
};
